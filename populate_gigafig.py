...
def populate():
    soapdvo2_paper = add_paper(
        doi_suffix='2047-217X-1-18',
    ...
    soapdvo2_fig1 = add_figure(
        paper=soapdvo2_paper,
    ...
    add_table_workflow(
        paper=soapdvo2_paper,
        table=soapdvo2_tab2,
        url="http://gigagalaxy.net/workflow/export?id=f2db41e1fa331b3e",
        galaxy_id="f2db41e1fa331b3e",
        name="tab2_wf1",
        ...
        history_id="0b37776e18390093")

    add_table_workflow(
        paper=soapdvo2_paper,
        table=soapdvo2_tab2,
        url="http://gigagalaxy.net/workflow/export?id=f597429621d6eb2b",
        galaxy_id="f597429621d6eb2b",
        name="tab2_wf2",
        ...
        history_id="c9e6d3334aa430f4")

    add_table_workflow(
        paper=soapdvo2_paper,
        table=soapdvo2_tab2,
        url="http://gigagalaxy.net/workflow/export?id=ebfb8f50c6abde6d",
        galaxy_id="ebfb8f50c6abde6d",
        name="tab2_wf3",
        title="SOAPdenovo1 assembly of S. aureus short reads",
        description="This pipeline uses SOAPdenovo2 to assemble short reads from S. aureus. Statistics for the assembly are calculated using the GAGE analysis script",
        history_id="09a1e8ac238ed3d9")

    add_table_workflow(
        paper=soapdvo2_paper,
        table=soapdvo2_tab2,
        url="http://gigagalaxy.net/workflow/export?id=1cd8e2f6b131e891",
        galaxy_id="1cd8e2f6b131e891",
        name="tab2_wf4",
        ...
        history_id="1db633912b8cbbf6")

    add_table_workflow(
        paper=soapdvo2_paper,
        table=soapdvo2_tab2,
        url="http://gigagalaxy.net/workflow/export?id=33b43b4e7093c91f",
        galaxy_id="33b43b4e7093c91f",
        name="tab2_wf5",
        ...
        history_id="d94929fc9baceae5")

    add_table_workflow(
        paper=soapdvo2_paper,
        table=soapdvo2_tab2,
        url="http://gigagalaxy.net/workflow/export?id=a799d38679e985db",
        galaxy_id="a799d38679e985db",
        name="tab2_wf6",
        ...
        history_id="20dece60f529586f")

    soapdvo2_tab3 = add_table(
        paper=soapdvo2_paper,
    ...
    gendiv_paper = add_paper(
        doi_suffix='2047-217X-2-17',
    ...
    add_figure_workflow(
        paper=gendiv_paper,
        figure=gendiv_fig2,
        url="http://gigagalaxy.net/workflow/export?id=5969b1f7201f12ae",
        galaxy_id="5969b1f7201f12ae",
        name="fig2_wf1",
        ...
        history_id="479f4daf148613ff")

    add_figure_workflow(
        paper=gendiv_paper,
        figure=gendiv_fig2,
        url="http://gigagalaxy.net/workflow/export?id=0a248a1f62a0cc04",
        galaxy_id="0a248a1f62a0cc04",
        name="fig2_wf2",
        ...
        history_id="21d6abf48ce833a8")

    add_figure_workflow(
        paper=gendiv_paper,
        figure=gendiv_fig2,
        url="http://gigagalaxy.net/workflow/export?id=03501d7626bd192f",
        galaxy_id="03501d7626bd192f",
        name="fig2_wf3",
        title="Nucleotide diversity of Aye-Aye populations",
        description="The degree of polymorphism within a population can be measured by examining nucleotide diversity. One measure of nucleotide diversity is pi, the average number of nucleotide differences per site between any two DNA sequences chosen randomly from the sample population. pi was evaluated in this workflow by synthesizing a human data set that matched the Aye-aye sequences in numbers of individuals and sequence depth. The results shown in the history_id suggest that nucleotide diversity within each of the three Aye-aye populations is relatively low.",
        history_id="24f04bd897e6fbd3")

    gendiv_fig3 = add_figure(
        paper=gendiv_paper,
    ...
    add_figure_workflow(
        paper=gendiv_paper,
        figure=gendiv_fig4,
        url="http://gigagalaxy.net/workflow/export?id=3f5830403180d620",
        galaxy_id="3f5830403180d620",
        name="fig4_wf",
        ...
        history_id="edbb4ff980c43f09")

    gendiv_fig5 = add_figure(
        paper=gendiv_paper,
    ...
    smilefinder_paper = add_paper(
        doi_suffix='2047-217X-X-XX',
        gigasci_url='',
    ...
    add_figure_workflow(
        paper=smilefinder_paper,
        figure=sf_fig1,
        url="http://gigagalaxy.net/workflow/export?id=c9468fdb6dc5c5f1",
        galaxy_id="c9468fdb6dc5c5f1",
        name="fig1_wf",
...
def add_figure_workflow(paper, figure, url, galaxy_id, name, title, description, history_id):
...
def add_table_workflow(paper, table, url, galaxy_id, name, title, description, history_id):
    wf = Workflow.objects.get_or_create(paper=paper,
                                        url=url,
                                        galaxy_id=galaxy_id,
                                        table=table,
